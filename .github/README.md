...
```text
sha384-aXkEHwXJJnk0uhObxPkK878nAgUDqAkVx7YssnmpRdV2PADhBtTwsaBBWFRJWpI8
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.87.0/index.min.mjs": "sha384-aXkEHwXJJnk0uhObxPkK878nAgUDqAkVx7YssnmpRdV2PADhBtTwsaBBWFRJWpI8"
        }
      }
</script>
```
