...
```text
sha384-GkXTqNcDdnFDzUez6kN+stY4uog0+nGDIeC2FzfQ3t4RVWt+mmCqqghxQc43dxzE
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.279.0/index.min.mjs": "sha384-GkXTqNcDdnFDzUez6kN+stY4uog0+nGDIeC2FzfQ3t4RVWt+mmCqqghxQc43dxzE"
        }
      }
</script>
```
