...
```text
sha384-De0vN0+m9+YzlGzpKVDyEbdy3r6U8kJKgrHoeRlH5u7wIKfPJUJvxen/NEtdh84d
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.840.0/index.min.mjs": "sha384-De0vN0+m9+YzlGzpKVDyEbdy3r6U8kJKgrHoeRlH5u7wIKfPJUJvxen/NEtdh84d"
        }
      }
</script>
```
