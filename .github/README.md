...
```text
sha384-2hD1WMtp4aQlFzAsPtuCjFD+c/NMgsEcemZjnpYwfWX+uRdBOcPGwYBCdlwpLrmH
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.31.0/index.min.mjs": "sha384-2hD1WMtp4aQlFzAsPtuCjFD+c/NMgsEcemZjnpYwfWX+uRdBOcPGwYBCdlwpLrmH"
        }
      }
</script>
```
