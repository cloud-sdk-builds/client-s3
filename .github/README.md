...
```text
sha384-sl44+oOZ7simZCCKmbNfCpurUQR5Ik90FqUFXKEs1AZEZFYAyF7jJDVqCAzTABYN
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.906.0/index.min.mjs": "sha384-sl44+oOZ7simZCCKmbNfCpurUQR5Ik90FqUFXKEs1AZEZFYAyF7jJDVqCAzTABYN"
        }
      }
</script>
```
