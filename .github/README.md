...
```text
sha384-XTXZkfPvNlIrMDmlrEQi4Lvj+YlBGXS2H8QinwNOe4USLBpJysrzF3+61TKh/6zf
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.507.0/index.min.mjs": "sha384-XTXZkfPvNlIrMDmlrEQi4Lvj+YlBGXS2H8QinwNOe4USLBpJysrzF3+61TKh/6zf"
        }
      }
</script>
```
