...
```text
sha384-PZWSRZLIYepQlSgQePJc1tNNODRPLoqpHIHB2gV+8VRoMOSEprzdlGhmVAfqWsQl
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.896.0/index.min.mjs": "sha384-PZWSRZLIYepQlSgQePJc1tNNODRPLoqpHIHB2gV+8VRoMOSEprzdlGhmVAfqWsQl"
        }
      }
</script>
```
