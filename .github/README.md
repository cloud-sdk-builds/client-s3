...
```text
sha384-JhvPNVdaMkF3dyO7HrPRing+8FPSGMdDZGXDavQXOwRnprTjuNfGb12CWPbtUHHB
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.170.0/index.min.mjs": "sha384-JhvPNVdaMkF3dyO7HrPRing+8FPSGMdDZGXDavQXOwRnprTjuNfGb12CWPbtUHHB"
        }
      }
</script>
```
