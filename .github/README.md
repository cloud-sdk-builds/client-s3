...
```text
sha384-bcKrFyf1eLyWNyYaZxHgd+mP0sZdxjPlRwxieOKIq+6b/TMq7beOUmZYjjkvHOK5
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.563.0/index.min.mjs": "sha384-bcKrFyf1eLyWNyYaZxHgd+mP0sZdxjPlRwxieOKIq+6b/TMq7beOUmZYjjkvHOK5"
        }
      }
</script>
```
