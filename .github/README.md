...
```text
sha384-pOwvTTkhTiNDSVoV9CZLvThzehUKLwScw2MIOIMQ4a0AxwsNHku/CMBkknqDhGYj
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.360.0/index.min.mjs": "sha384-pOwvTTkhTiNDSVoV9CZLvThzehUKLwScw2MIOIMQ4a0AxwsNHku/CMBkknqDhGYj"
        }
      }
</script>
```
