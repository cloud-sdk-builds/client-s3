...
```text
sha384-srfu0mtaR3HaFeV4V5klRn2+3DQE4orrBmzS2TaYEPSc9kIg76rYq14oJgps5CKV
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.210.0/index.min.mjs": "sha384-srfu0mtaR3HaFeV4V5klRn2+3DQE4orrBmzS2TaYEPSc9kIg76rYq14oJgps5CKV"
        }
      }
</script>
```
