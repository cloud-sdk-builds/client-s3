...
```text
sha384-7dCOFGZ+yCRBERyY0JVobB2P97mBeKZGlRhQAdFOLMGpmzG3+NV/DHrXd7jL9NbT
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.49.0/index.min.mjs": "sha384-7dCOFGZ+yCRBERyY0JVobB2P97mBeKZGlRhQAdFOLMGpmzG3+NV/DHrXd7jL9NbT"
        }
      }
</script>
```
