...
SRI SHA Hash
```text
sha384-29aaBh/v6Skc8+djfctNsvELzprqAKLQ+8/v3mCzGwkqIZz35pBM0oEpDJ7CD+/M
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.417.0/index.min.mjs": "sha384-29aaBh/v6Skc8+djfctNsvELzprqAKLQ+8/v3mCzGwkqIZz35pBM0oEpDJ7CD+/M"
        }
      }
    </script>
  </head>
