...
```text
sha384-SlKa6uHD9tWKcCzXSOcyMqKry4dvTiedwMmfjGZYDkLVCSPw11XyVRdMkkshgyyr
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.967.0/index.min.mjs": "sha384-SlKa6uHD9tWKcCzXSOcyMqKry4dvTiedwMmfjGZYDkLVCSPw11XyVRdMkkshgyyr"
        }
      }
</script>
```
