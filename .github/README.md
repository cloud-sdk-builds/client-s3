...
```text
sha384-ydnNfsBXDwLJOFE6fs4d1XB2uVu4brgbwPwol4hIbob/ghazMHlZFQPXixJgatlP
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.835.0/index.min.mjs": "sha384-ydnNfsBXDwLJOFE6fs4d1XB2uVu4brgbwPwol4hIbob/ghazMHlZFQPXixJgatlP"
        }
      }
</script>
```
