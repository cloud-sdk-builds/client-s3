...
```text
sha384-SF0jcpWH+FN83jAabAozEpHaGzTdCtOImXJBBAUsAoHMjZ3Mdly9sSaw0mlpUfCW
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.358.0/index.min.mjs": "sha384-SF0jcpWH+FN83jAabAozEpHaGzTdCtOImXJBBAUsAoHMjZ3Mdly9sSaw0mlpUfCW"
        }
      }
</script>
```
