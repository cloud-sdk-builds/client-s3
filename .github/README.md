...
```text
sha384-URgcuREBXTYCebYtBG2M3i+M1ZQIF4bYymIZgGimMQjzHdrBd5ywDXZIZAOSc8t8
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.290.0/index.min.mjs": "sha384-URgcuREBXTYCebYtBG2M3i+M1ZQIF4bYymIZgGimMQjzHdrBd5ywDXZIZAOSc8t8"
        }
      }
</script>
```
