...
```text
sha384-gWZufEpNJEJMpzVpWpzoy1UUqycNMkR+1eW2Q/Zz1kocEAZShtPsZFwy+beOi0s6
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.552.0/index.min.mjs": "sha384-gWZufEpNJEJMpzVpWpzoy1UUqycNMkR+1eW2Q/Zz1kocEAZShtPsZFwy+beOi0s6"
        }
      }
</script>
```
