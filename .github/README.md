...
```text
sha384-pCWYbV8rEnAJcfSmQq1Ot8WK9siCG+tSrh7Opg+k0np+890OsOMyQZPCQKUmmgSb
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.76.0/index.min.mjs": "sha384-pCWYbV8rEnAJcfSmQq1Ot8WK9siCG+tSrh7Opg+k0np+890OsOMyQZPCQKUmmgSb"
        }
      }
</script>
```
