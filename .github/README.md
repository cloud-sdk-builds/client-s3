...
SRI SHA Hash
```text
sha384-xSex/k7kvUaGLZyo+gV+D9gQw7b836OEMmf+xEZ++rzJyzi9ycTyLO6UIx21aVTl
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.501.0/index.min.mjs": "sha384-xSex/k7kvUaGLZyo+gV+D9gQw7b836OEMmf+xEZ++rzJyzi9ycTyLO6UIx21aVTl"
        }
      }
    </script>
  </head>
