...
```text
sha384-MnyVcAHYdycfImeEo+i22g1gXSc/EheO/Fji2wMZdvCxDE2F7OFhaYbj+i+jaIOE
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.842.0/index.min.mjs": "sha384-MnyVcAHYdycfImeEo+i22g1gXSc/EheO/Fji2wMZdvCxDE2F7OFhaYbj+i+jaIOE"
        }
      }
</script>
```
