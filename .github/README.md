...
```text
sha384-kvb6HN7wwKysM0NI2Bxfzy0ZUoVeC1+JKc6TTO8m+H+xdFfSONwa0s9QJ29l7eac
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.386.0/index.min.mjs": "sha384-kvb6HN7wwKysM0NI2Bxfzy0ZUoVeC1+JKc6TTO8m+H+xdFfSONwa0s9QJ29l7eac"
        }
      }
</script>
```
