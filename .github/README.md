...
```text
sha384-qpm+kPSXb5xhXHyOLGK+vmQh7+vKouQ+auqjhOxrUlvCai/f01fCm9UC0d78mgkh
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.985.0/index.min.mjs": "sha384-qpm+kPSXb5xhXHyOLGK+vmQh7+vKouQ+auqjhOxrUlvCai/f01fCm9UC0d78mgkh"
        }
      }
</script>
```
