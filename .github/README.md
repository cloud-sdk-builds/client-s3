...
SRI SHA Hash
```text
sha384-Oi++dOTKbGYoMFns3kP2D6zYsPFWid8akxJCV83jrziYcaY4iqgREycFzJrjooGN
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.282.0/index.min.mjs": "sha384-Oi++dOTKbGYoMFns3kP2D6zYsPFWid8akxJCV83jrziYcaY4iqgREycFzJrjooGN"
        }
      }
    </script>
  </head>
