...
```text
sha384-csZWYTFh2mMwH5tOF+unMjnfsl9vIeoCFhkChDg3cLnYzwDQTs/JDWsJWIzxpPyh
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.892.0/index.min.mjs": "sha384-csZWYTFh2mMwH5tOF+unMjnfsl9vIeoCFhkChDg3cLnYzwDQTs/JDWsJWIzxpPyh"
        }
      }
</script>
```
