...
```text
sha384-iUPYzeX2yVzwD2RDXTzqusaSS+yTedYjl7+Yu2efVPxsVhiSzmuaCGumwxjKpEBM
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.254.0/index.min.mjs": "sha384-iUPYzeX2yVzwD2RDXTzqusaSS+yTedYjl7+Yu2efVPxsVhiSzmuaCGumwxjKpEBM"
        }
      }
</script>
```
