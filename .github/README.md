...
```text
sha384-zzKsDmlMuXWa3fnzeERz2GWeX8C+vy0EwWetdSdBmRUNDbLVsns62DVR+iGzrhqo
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.347.0/index.min.mjs": "sha384-zzKsDmlMuXWa3fnzeERz2GWeX8C+vy0EwWetdSdBmRUNDbLVsns62DVR+iGzrhqo"
        }
      }
</script>
```
