...
SRI SHA Hash
```text
sha384-+kLE3nyeoRH2b1lJnHLFnageNzpQbkiBhfRxvSjRbrVbZWPvMWQW6UADCrWTSd5f
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.779.0/index.min.mjs": "sha384-+kLE3nyeoRH2b1lJnHLFnageNzpQbkiBhfRxvSjRbrVbZWPvMWQW6UADCrWTSd5f"
        }
      }
    </script>
  </head>
