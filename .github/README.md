...
```text
sha384-NHBrCAuRPrGCRPMpef/OC0oxD3+edugK2qhBKejKaFUIEOLOwpkLQSdVR8pSN4Ao
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.168.0/index.min.mjs": "sha384-NHBrCAuRPrGCRPMpef/OC0oxD3+edugK2qhBKejKaFUIEOLOwpkLQSdVR8pSN4Ao"
        }
      }
</script>
```
