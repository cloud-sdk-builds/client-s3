...
```text
sha384-GDAcrDmpgsYG5wqdc6Vo5hROosqW/m+nHTxbyH8e0Fp6dtSY/jqJoGy7DsMBHxV9
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.7.0/index.min.mjs": "sha384-GDAcrDmpgsYG5wqdc6Vo5hROosqW/m+nHTxbyH8e0Fp6dtSY/jqJoGy7DsMBHxV9"
        }
      }
</script>
```
