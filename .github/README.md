...
```text
sha384-LXK6SFAaciPbPdrqilyLw9t3CwbKWMA5zhVFgJHcbgKTpLAGyrKmvGk2IhEb84y4
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.8.0/index.min.mjs": "sha384-LXK6SFAaciPbPdrqilyLw9t3CwbKWMA5zhVFgJHcbgKTpLAGyrKmvGk2IhEb84y4"
        }
      }
</script>
```
