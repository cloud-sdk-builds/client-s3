...
```text
sha384-BXsOZWUttR8K+GhELNA7+HsdI7qhWWdMH5+lG+fhEbd8HjEMNb8BgghZTytrA6vT
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.458.0/index.min.mjs": "sha384-BXsOZWUttR8K+GhELNA7+HsdI7qhWWdMH5+lG+fhEbd8HjEMNb8BgghZTytrA6vT"
        }
      }
</script>
```
