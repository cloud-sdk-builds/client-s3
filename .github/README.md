...
```text
sha384-vn7OfEFQuF+7+yWJhdd2016qrpd0C5S3K/F+UrI7mRZrG9nrrNyCVhySrE/ObpIN
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.129.0/index.min.mjs": "sha384-vn7OfEFQuF+7+yWJhdd2016qrpd0C5S3K/F+UrI7mRZrG9nrrNyCVhySrE/ObpIN"
        }
      }
</script>
```
