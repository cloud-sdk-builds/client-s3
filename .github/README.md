...
```text
sha384-s4dwhldI+96uMMl0Dveirsh/mbhnjtgjeQYMosB/NW3HqZ/appZBOBhXguKsMuJk
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.335.0/index.min.mjs": "sha384-s4dwhldI+96uMMl0Dveirsh/mbhnjtgjeQYMosB/NW3HqZ/appZBOBhXguKsMuJk"
        }
      }
</script>
```
