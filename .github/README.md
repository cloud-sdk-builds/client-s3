...
SRI SHA Hash
```text
sha384-+V5poolxoHBpVmnKjLoXo2zpr+5S64f0x+MHqROygTZuEiScyefA3USAiyoJtgqS
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.262.0/index.min.mjs": "sha384-+V5poolxoHBpVmnKjLoXo2zpr+5S64f0x+MHqROygTZuEiScyefA3USAiyoJtgqS"
        }
      }
    </script>
  </head>
