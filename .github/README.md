...
```text
sha384-QarIglty0qTxunLAa2NkSziU/WEVmPEZdhCrS9++zLLnoQZpys8RAL5VdOkJAmzB
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.429.0/index.min.mjs": "sha384-QarIglty0qTxunLAa2NkSziU/WEVmPEZdhCrS9++zLLnoQZpys8RAL5VdOkJAmzB"
        }
      }
</script>
```
