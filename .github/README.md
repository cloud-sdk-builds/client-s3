...
```text
sha384-8lMdhp4os3YvoIq3DNgx9bu9eDqPGskT/BB48aWjBhK8DUKWZ2s/H8+bEmo5k0+C
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.837.0/index.min.mjs": "sha384-8lMdhp4os3YvoIq3DNgx9bu9eDqPGskT/BB48aWjBhK8DUKWZ2s/H8+bEmo5k0+C"
        }
      }
</script>
```
