...
```text
sha384-o1XwwSjnChAk0cfMmo2GHHcuIpsb2OR5fv83RC5PSeTxNHrVLM0galHRsLJpkOwD
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.354.0/index.min.mjs": "sha384-o1XwwSjnChAk0cfMmo2GHHcuIpsb2OR5fv83RC5PSeTxNHrVLM0galHRsLJpkOwD"
        }
      }
</script>
```
