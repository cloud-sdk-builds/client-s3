...
```text
sha384-kRUBmgCE8iqSa8+4V05ZXRegSEKsQVTjbU9NmUdoVS0QZkWUWAySu9qCPnZGWxm2
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.743.0/index.min.mjs": "sha384-kRUBmgCE8iqSa8+4V05ZXRegSEKsQVTjbU9NmUdoVS0QZkWUWAySu9qCPnZGWxm2"
        }
      }
</script>
```
