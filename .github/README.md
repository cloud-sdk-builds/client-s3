...
```text
sha384-mCIQbPAaghx/UHxAzqw+ajr86rKlyBrmwZM9SPgtmfoWXjCU8vRuRSdQj0m9+heI
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.565.0/index.min.mjs": "sha384-mCIQbPAaghx/UHxAzqw+ajr86rKlyBrmwZM9SPgtmfoWXjCU8vRuRSdQj0m9+heI"
        }
      }
</script>
```
