...
```text
sha384-oGAT2s7eRDe4YZ0CsUjMgCOQFDn/i01SlXeem5LduHOgPcC1neDHTurWBxTvKdZX
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.53.1/index.min.mjs": "sha384-oGAT2s7eRDe4YZ0CsUjMgCOQFDn/i01SlXeem5LduHOgPcC1neDHTurWBxTvKdZX"
        }
      }
</script>
```
