...
SRI SHA Hash
```text
sha384-/gfnVHTHaavqKIAaFaOpZ7/R7rpS7wYqtmGw/hUbRBocFfVf+kgYQxXR79o9mv+c
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.325.0/index.min.mjs": "sha384-/gfnVHTHaavqKIAaFaOpZ7/R7rpS7wYqtmGw/hUbRBocFfVf+kgYQxXR79o9mv+c"
        }
      }
    </script>
  </head>
