...
[`@aws-sdk/client-s3`](https://www.npmjs.com/package/@aws-sdk/client-s3/v/3.6.4).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.6.4/index.min.mjs
```

SRI SHA Hash
```text
sha384-9sY5UpdPJH4fhsc0fEGqgocxdl+i5EkjkLljeYBXG4dlnVA+Wce7puGp2mLCEdpt
```
...
<html>
  <head>
    <script type="importmap">
      {
        "imports": {
          "@aws-sdk/client-s3": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.6.4/index.min.mjs"
        },
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.6.4/index.min.mjs": "sha384-9sY5UpdPJH4fhsc0fEGqgocxdl+i5EkjkLljeYBXG4dlnVA+Wce7puGp2mLCEdpt"
        }
      }
    </script>
  </head>
...
* Always pin to a specific version (`@3.6.4`)
...
```
https://github.com/cloud-sdk-builds/client-s3/blob/refs/tags/3.6.4/LICENSE
```
