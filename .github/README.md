...
```text
sha384-7ZkCHznklfrMHDs6IelNq2qpPsOVskTzZl3ISOh+spuL3V31iGo6Udctr4nkipet
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.732.0/index.min.mjs": "sha384-7ZkCHznklfrMHDs6IelNq2qpPsOVskTzZl3ISOh+spuL3V31iGo6Udctr4nkipet"
        }
      }
</script>
```
