...
SRI SHA Hash
```text
sha384-WVhDm15MJUyTWZYY0tNqjKTTu/RpeurJQNLZE//IOC3b5WHQTXtfYm9xUsnb7AtG
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.583.0/index.min.mjs": "sha384-WVhDm15MJUyTWZYY0tNqjKTTu/RpeurJQNLZE//IOC3b5WHQTXtfYm9xUsnb7AtG"
        }
      }
    </script>
  </head>
