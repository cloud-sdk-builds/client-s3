...
```text
sha384-Cbfqb0+vUhW+cb6jbgVZ4OY2fXkJnD4aP7xGZWQ0tbhDqKHLv1UFtUWk6AQQ/lDX
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.667.0/index.min.mjs": "sha384-Cbfqb0+vUhW+cb6jbgVZ4OY2fXkJnD4aP7xGZWQ0tbhDqKHLv1UFtUWk6AQQ/lDX"
        }
      }
</script>
```
