...
SRI SHA Hash
```text
sha384-+XRJhRGqIxUH2sURBeurH2Wueyhc7JuVKSpdSnKQlHSAGVF6Zt3v9DFRqsb56WS2
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.36.1/index.min.mjs": "sha384-+XRJhRGqIxUH2sURBeurH2Wueyhc7JuVKSpdSnKQlHSAGVF6Zt3v9DFRqsb56WS2"
        }
      }
    </script>
  </head>
