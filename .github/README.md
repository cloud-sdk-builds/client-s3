...
SRI SHA Hash
```text
sha384-+ooLPrrAvNg8FibBpu2e6ghPEZQzIlXUS59ziAb9PpTGVZwhmUUD0GMkzfanzGqU
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.477.0/index.min.mjs": "sha384-+ooLPrrAvNg8FibBpu2e6ghPEZQzIlXUS59ziAb9PpTGVZwhmUUD0GMkzfanzGqU"
        }
      }
    </script>
  </head>
