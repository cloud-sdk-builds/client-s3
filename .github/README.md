...
```text
sha384-OPtTpXPZ3YPd1MKxemd2XeI8LwutnOKlGoIScZvhbRKcU5SMjxW5OMyBqlJHwGUA
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.682.0/index.min.mjs": "sha384-OPtTpXPZ3YPd1MKxemd2XeI8LwutnOKlGoIScZvhbRKcU5SMjxW5OMyBqlJHwGUA"
        }
      }
</script>
```
