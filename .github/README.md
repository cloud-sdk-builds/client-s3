...
```text
sha384-t1vIGyFqC2/zHLTInRh22ZdxuKtW7lkrTrY+oLm7aDKvEGQByj6QJ/hl+ZDPvLzt
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.51.0/index.min.mjs": "sha384-t1vIGyFqC2/zHLTInRh22ZdxuKtW7lkrTrY+oLm7aDKvEGQByj6QJ/hl+ZDPvLzt"
        }
      }
</script>
```
