...
```text
sha384-lRKEnxvLZkASUAU+zokoQOxJfL9hP+AeDYrmMlTQd5UxBzWSSRc+FiAMtaWJPL98
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.686.0/index.min.mjs": "sha384-lRKEnxvLZkASUAU+zokoQOxJfL9hP+AeDYrmMlTQd5UxBzWSSRc+FiAMtaWJPL98"
        }
      }
</script>
```
