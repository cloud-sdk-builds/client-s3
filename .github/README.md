...
```text
sha384-kCpZUd9nmPt41GnVIDzeSgbz00YurJFuHnkwSO+h0+MJlJu4XB/z2+rwx1G9CmeD
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.427.0/index.min.mjs": "sha384-kCpZUd9nmPt41GnVIDzeSgbz00YurJFuHnkwSO+h0+MJlJu4XB/z2+rwx1G9CmeD"
        }
      }
</script>
```
