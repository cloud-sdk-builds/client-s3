...
```text
sha384-NWRoEHG2ER8D9MQK529eg/CXOnaEULJ+qqwOB+M3ddelO0FjNNRX/8GHulnqYusb
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.738.0/index.min.mjs": "sha384-NWRoEHG2ER8D9MQK529eg/CXOnaEULJ+qqwOB+M3ddelO0FjNNRX/8GHulnqYusb"
        }
      }
</script>
```
