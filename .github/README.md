...
```text
sha384-GIKbDetK2kq9jYQBOGfLG5IgAV0muTwaCPPBQQMqfspeAZxuHop5WF5IEpyoTvYA
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.592.0/index.min.mjs": "sha384-GIKbDetK2kq9jYQBOGfLG5IgAV0muTwaCPPBQQMqfspeAZxuHop5WF5IEpyoTvYA"
        }
      }
</script>
```
