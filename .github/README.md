...
SRI SHA Hash
```text
sha384-wtM2Fcj3duIgASE8KYZlLOYNlhgyWkAvQk/icuDHChRcKokYpkzAwaVT0LEayKB+
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.420.0/index.min.mjs": "sha384-wtM2Fcj3duIgASE8KYZlLOYNlhgyWkAvQk/icuDHChRcKokYpkzAwaVT0LEayKB+"
        }
      }
    </script>
  </head>
