...
SRI SHA Hash
```text
sha384-zdPAoKuiTYObfaLzrklekEolq0zo4dzWlDcZyHGrdZ8hReVtBrrWEyrueX3y8Ox/
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.787.0/index.min.mjs": "sha384-zdPAoKuiTYObfaLzrklekEolq0zo4dzWlDcZyHGrdZ8hReVtBrrWEyrueX3y8Ox/"
        }
      }
    </script>
  </head>
