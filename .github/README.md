...
SRI SHA Hash
```text
sha384-/f+tcmiymv9mJ5Ug/q2we/nkuibosHHhGyfvvDwfkBFw+WBcJ8uRFZvK5YLDyQaz
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.88.0/index.min.mjs": "sha384-/f+tcmiymv9mJ5Ug/q2we/nkuibosHHhGyfvvDwfkBFw+WBcJ8uRFZvK5YLDyQaz"
        }
      }
    </script>
  </head>
