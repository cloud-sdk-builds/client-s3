...
SRI SHA Hash
```text
sha384-+vEwY3OlqbYLx9NUVoZjiKj84fE2/F31OhHJak+cZpmGvoaTgbACPjWZBvOX3CEa
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.241.0/index.min.mjs": "sha384-+vEwY3OlqbYLx9NUVoZjiKj84fE2/F31OhHJak+cZpmGvoaTgbACPjWZBvOX3CEa"
        }
      }
    </script>
  </head>
