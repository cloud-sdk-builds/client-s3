...
```text
sha384-Le+/f+FM2Mzq+PyQnoNWONCUUwnmHJvoAceFf0//GVm98Gxy2ObypHirdaRDPFkP
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.395.0/index.min.mjs": "sha384-Le+/f+FM2Mzq+PyQnoNWONCUUwnmHJvoAceFf0//GVm98Gxy2ObypHirdaRDPFkP"
        }
      }
</script>
```
