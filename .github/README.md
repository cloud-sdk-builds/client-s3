...
```text
sha384-Z/BLbrNTuOt0PdgeSAU7+GJGUMZxg9gIzxSP9JJvdOyxyELY+NNDPHxhjtdVUs4/
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.832.0/index.min.mjs": "sha384-Z/BLbrNTuOt0PdgeSAU7+GJGUMZxg9gIzxSP9JJvdOyxyELY+NNDPHxhjtdVUs4/"
        }
      }
</script>
```
