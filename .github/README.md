...
```text
sha384-kcqju1mLsabmXdLUraeam6WFsg18hFjLvpc6+28U66+V/DbONaFsZ9t3YRCXdslM
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.16.0/index.min.mjs": "sha384-kcqju1mLsabmXdLUraeam6WFsg18hFjLvpc6+28U66+V/DbONaFsZ9t3YRCXdslM"
        }
      }
</script>
```
