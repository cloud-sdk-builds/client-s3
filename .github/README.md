...
[`@aws-sdk/client-s3`](https://www.npmjs.com/package/@aws-sdk/client-s3/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.47.2/index.min.mjs
```

SRI SHA Hash
```text
sha384-T9ejCte0Vw0Gx8eeQ+kDg9xMMaubPR3U5PSwssH0pGjZ8H2FsErKDWWcu80vOPFa
```
...
<html>
  <head>
    <script type="importmap">
      {
        "imports": {
          "@aws-sdk/client-s3": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.47.2/index.min.mjs"
        },
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.47.2/index.min.mjs": "sha384-T9ejCte0Vw0Gx8eeQ+kDg9xMMaubPR3U5PSwssH0pGjZ8H2FsErKDWWcu80vOPFa"
        }
      }
    </script>
  </head>
...
```
https://github.com/cloud-sdk-builds/client-s3/blob/refs/tags/3.47.2/LICENSE
```
