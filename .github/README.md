...
SRI SHA Hash
```text
sha384-msoyrnbCS3xIcP4L6dcVQ+S7gVWC1GYQFcjSf3Pejq+/tupB3sza2pHbEFbCVJjY
```
    ...
    <script type="importmap">
      {
        ...
        "integrity": {
          "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.859.0/index.min.mjs": "sha384-msoyrnbCS3xIcP4L6dcVQ+S7gVWC1GYQFcjSf3Pejq+/tupB3sza2pHbEFbCVJjY"
        }
      }
    </script>
  </head>
