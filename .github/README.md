...
```text
sha384-lIiHN++awpMjTolL9lpTWGBD6FX2/xAXiixb4hrTO85hfGgCBPykEUkefP+T3KlQ
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.171.0/index.min.mjs": "sha384-lIiHN++awpMjTolL9lpTWGBD6FX2/xAXiixb4hrTO85hfGgCBPykEUkefP+T3KlQ"
        }
      }
</script>
```
