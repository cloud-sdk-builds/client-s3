...
```text
sha384-Gzmn4ZE03aQGutMqxpm0if/cNovRjPUpqMJFHdT/eAdlgggxglkHzV1sWtV0fP25
```
...
<script type="importmap">
      {
        "imports": {
          ...
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3@3.514.0/index.min.mjs": "sha384-Gzmn4ZE03aQGutMqxpm0if/cNovRjPUpqMJFHdT/eAdlgggxglkHzV1sWtV0fP25"
        }
      }
</script>
```
